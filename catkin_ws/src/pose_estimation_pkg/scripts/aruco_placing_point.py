...
if __name__ == "__main__":
    ...
    rospy.init_node("aruco_placing_point_node")
    pub = rospy.Publisher("/aruco/img_placing_point", sensor_msgs.msg.Image, queue_size=1)
    ...
    rate = rospy.Rate(15) # this has to be checked in order to do a good filtering, check also the transformation from 2D to 3D
    time.sleep(5.0) # wait 5 seconds until the realsense is initialized 
