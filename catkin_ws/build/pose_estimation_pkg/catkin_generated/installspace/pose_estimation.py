...
if __name__ == "__main__":
    ...
    #scene_pcd, inliers = remove_color_outlier(cloud=scene_pcd, color_threshold=170)
    #scene_pcd = threshold_filter_min_max(scene_pcd, axis=2, min_distance=0.3, max_distance=0.60)
    ...
    #scene_pcd_clustered, nb_clusters, scene_pcd = cluster_dbscan(cloud=scene_pcd, eps=0.01, min_samples=20, min_points_cluster = 100, display=False)
